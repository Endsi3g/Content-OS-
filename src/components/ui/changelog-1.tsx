...
export const Changelog1 = ({
  ...
  return (
    <section className="py-12 md:py-16 overflow-y-auto">
      <div className="container">
        <div className="mx-auto max-w-3xl">
          <h1 className="mb-4 text-3xl font-bold tracking-tight md:text-5xl text-[var(--text-main)]">
            {title}
          </h1>
          <p className="mb-6 text-base text-[var(--text-muted)] md:text-lg">
            {description}
          </p>
        </div>
        <div className="mx-auto mt-16 max-w-3xl space-y-16 md:mt-24 md:space-y-24 pb-20">
          {entries.map((entry, index) => (
            ...
            >
              ...
              <div className="flex flex-col">
                <h2 className="mb-3 text-lg leading-tight font-bold text-[var(--text-main)] md:text-2xl">
                  {entry.title}
                </h2>
                ...
                {entry.items && entry.items.length > 0 && (
                  <ul className="mt-4 ml-4 space-y-1.5 text-sm text-[var(--text-muted)] md:text-base">
